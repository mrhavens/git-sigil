...
The  directory hosts a public-facing, SEO-optimized canonical declaration for the `git-sigil` repository, designed for GitHub Pages, GitLab Pages, and Codeberg Pages compatibility and enhanced discoverability.
...
- **GitLab Pages**: Deployed via , status: unknown
- **Codeberg Pages**: Deployed via , status: unknown
...
Generated by `gitfield-sync` at 2025-06-09T23:14:38Z (v1.5).
